...
if (!empty($_GET['endpointARN'])) {
    PushNotificationHelper::setup();
    PushNotificationHelper::sendMessage("$_GET[message]", $_GET['endpointARN']);
    success("Notification envoyée", "../index.php");
} else error("Aucun paramètres ARN", "../index.php");
