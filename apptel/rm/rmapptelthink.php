...
$idtel      = mysqli_real_escape_string($conn, $_POST['telid']);
$appname    = mysqli_real_escape_string($conn, $_POST['appname']);

if (isset($_POST['submit']) && isset($idtel) && isset($appname)) {
    $appid = $conn->query("SELECT id FROM chb_applications WHERE nom = \"$appname\"");
    $appid->data_seek(0);
    $rowapp = $appid->fetch_assoc();
    $sql = "DELETE FROM chb_apptel WHERE idtel = \"$idtel\" AND idapp = \"$rowapp[id]\"";
    if (mysqli_query($conn, $sql)) success("Disolution réussite", "");
    else error(mysqli_error($conn), "../telephones/listetel.php");
} else error("Variable vide", "../telephones/listetel.php");
?>
<!DOCTYPE html>
<html lang="fr">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dissocier une application</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
