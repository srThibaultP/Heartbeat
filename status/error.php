    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../index.php" class="brand-link">
                <img src="../assets/cube.png" alt="Cube logo" class="brand-image"
                    style="opacity: .8">
        ...
        <div class="content-wrapper">
            ...
            <!-- general form elements -->
                <div class="card bg-gradient-danger">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <h3><?php echo htmlspecialchars($_SESSION['error']);?></h3>
                  </div>
                  <!-- /.card-body -->
                  <div class="card-footer">
                  <a href="<?php $link=$_SESSION['link']; if(empty($link)) $link = "../index.php"; echo $link;?>"><button type="submit" class="btn btn-primary">Retour</button></a>
                  </div>
                </div>
                <!-- /.card -->
              </div>
