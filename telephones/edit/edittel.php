...
if (!$conn->connect_errno) $res = $conn->query("SELECT nom FROM chb_telephones");
if($_POST['idtel']) {
    $_SESSION['idtel'] = $_POST['idtel'];
    header("Refresh: 0; url = editingtel.php");
}
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Modifier un téléphone</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content d-flex justify-content-center">
                <form role="form" action="editingtel.php" method="POST">
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="edit">
                                    <option disabled selected value> -- Sélectioner le nom du téléphone -- </option>
                                    <?php
                                    $res->data_seek(0);
