            ...
            <div class="content d-flex justify-content-center">
                ...
                <div class="card card-primary w-25">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Nouveau téléphone</h3>
                    </div>
                    <form role="form" action="addtelthink.php" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nom du téléphone :</label>
                                <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom du téléphone" required>
                            </div>
                            <label>Système d'exploitation du téléphone :</label>
                            <fieldset>
                                <div class="col-sm-10 checkbox-group required">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type[]" value="Android" required>
                                        <label class="form-check-label" for="gridRadios1">
                                            Android
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type[]" value="iOS" required>
