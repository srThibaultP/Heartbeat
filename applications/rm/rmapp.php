...
if (!empty($_POST['idapp'])) {
    ...
    $res = $conn->query("SELECT nom FROM chb_applications WHERE id = \"$idapp\"");
} else $res = $conn->query("SELECT nom FROM chb_applications");
?>
            ...
            <div class="content d-flex justify-content-center">
                <div class="card card-danger">
                    <div class="card-header">
                        <h3 class="card-title">Supprimer l'application</h3>
                    </div>
                    <form role="form" action="rmappthink.php" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nom de l'application :</label>
                                <select class="custom-select" name="supp">
                                    <?php
                                    if (empty($_POST['idapp'])) echo "<option disabled selected value> -- Sélectionner le nom de l'application -- </option>";
                                    $res->data_seek(0);
