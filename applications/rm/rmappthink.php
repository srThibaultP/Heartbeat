...
if (isset($_POST['submit'])) {
    $supp = mysqli_real_escape_string($conn, $_POST['supp']);
    if (empty($supp)) {
        error("Variable vide", "../applications/rm/rmapp.php");
    } else {
        $sqlfilepath = $conn->query("SELECT * FROM chb_applications WHERE nom = \"$supp\"");
        $sqlfilepath->data_seek(0);
        $filepath = $sqlfilepath->fetch_assoc();
        unlink("../../assets/$filepath[icone]");
        $sql = "DELETE FROM chb_applications WHERE nom = \"$supp\"";
        $sqlapptel = "DELETE FROM chb_apptel WHERE idapp = \"$filepath[id]\"";
        if (mysqli_query($conn, $sql) and mysqli_query($conn, $sqlapptel)) success("L'application est supprimée.", "../applications/listeapp.php");
        else error(mysqli_error($conn), "../applications/rm/rmapp.php");
    }
}
?>
<!DOCTYPE html>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../../applications/rm/rmapp.php" class="nav-link active">
