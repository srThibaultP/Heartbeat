...
if (!$conn->connect_errno) $res = $conn->query("SELECT nom FROM chb_applications");
if($_POST['idapp']) {
    $_SESSION['idapp'] = $_POST['idapp'];
    header("Refresh: 0; url = editingapp.php");
}
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Modifier une application</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content d-flex justify-content-center">
                <form role="form" action="editingapp.php" method="POST">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">Modifier l'application</h3>
                        </div>
                        <div class="card-body">
